...
var session = conf.session.replace(/DALINK-MD-WA-BOT;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['dalink-Md', "safari", "1.0.0"],
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const AndersonMgaya1='255657860770';
             const AndersonMgaya2='255718439880'*/
            /*  var superUser=[servBot,AndersonMgaya1,luffy].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
              var dev =[AndersonMgaya1,AndersonMgaya2].map((t)=>t.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);*/
            ...
            const superUserNumbers = [servBot,AndersonMgaya1, AndersonMgaya2,conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
            const allAllowedNumbers = superUserNumbers.concat(sudo);
            const superUser = allAllowedNumbers.includes(auteurMessage);
            
            var dev = [AndersonMgaya1,AndersonMgaya2].map((t) => t.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
            function repondre(mes) { zk.sendMessage(origineMessage, { text: mes }, { quoted: ms }); }
            console.log("\t [][]...{DALINK-MD}...[][]");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://telegra.ph/file/51b27187dc4d679244c56.png';
    }
...
📌Powered by *Anderson*`;
            ...
            let msg = `Goodbye to that Fallen soldier, Powered by *DALINK-MD*;\n`;
